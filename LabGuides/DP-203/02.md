...
1. On the desktop, click the **Azure Portal** shortcut to sign into the Azure Portal and sign in with the following credentials:
	...
	* **checkNNumber:** <inject key="testKey1" value="StaticValueOne" key="testkay2" value="StaticValueTwo" enableCopy="false" />
...
1. On the desktop, click the **Azure Portal** shortcut to sign into the Azure Portal and sign in with the following credentials:
	...
	* **checkNNumber:** <inject key="testKey1" value="StaticValueOne" key="testkay2"  value="StaticValueTwo" />
